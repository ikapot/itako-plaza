...
## 📚 5. 開発の歴史 (History)
私たちの対話からボットがどう進化したかについては、[EVOLUTION.md](./EVOLUTION.md) を参照してください。

## 🤖 AI "Tide Sense" について
本ボットは売買シグナルが発生した際、Gemini 1.5 Flash に対して「現在の市場価格推移から見た環境認識」を求めます。
AIが `BEARISH`（弱気）と判断した場合、テクニカル指標が買いを示してもエントリーを自動で見送ります。
