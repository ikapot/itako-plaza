...
export const INITIAL_CHARACTERS = [
  ...
  { id: 'kawabata', face: 0, pos: 5, name: '川端康成', role: 'ノーベル賞作家', homeLocationId: 'garden', flavor: '余韻', color: 'bg-itako-sage', description: '（1899年-1972年）大阪府生まれ。日本人初のノーベル文学賞受賞者であり、日本の繊細な美意識と死生観を世界に紹介した文豪。幼少期に両親、祖父母、姉を立て続けに失うという「喪失の連鎖」を経験し、この天涯孤独の境遇が彼の文学に潜む根源的な孤独と虚無感の基盤となった。東京帝国大学在学中に横光利一らと「新感覚派」を創刊し、映像的な知覚とモダニズムを融合させた手法で彗星のごとく登場した。代表作『伊豆の踊子』では清純な抒情性を、『雪国』では駒子の情熱と北国風景を透徹した冷徹な美で描き出し、官能と幽玄の極致を示した。1968年のノーベル賞受賞講演「美しい日本の私」では、禅や平安朝以来の美学を説き、生と死が隣り合わせにある日本の精神性を世界へ発信した。冷徹な観察眼を持つ一方で、三島由紀夫ら後進の才能を見出す「新人の発掘者」としても多大な貢献をした。古美術や少女小説への深い造詣も持ち、その作風は「奇術師」と称されるほど変遷に富む。1972年、逗子の家で遺書もなく自ら命を絶ったが、その孤独な最期もまた、彼が終生追求した「消えゆく美」の極北であったとされる。', avatar: 'assets/kawabata_warhol.png', isPreStyled: true },
  { id: 'kafuka', face: 0, pos: 6, name: 'カフカ', role: '保険局員・作家', homeLocationId: 'waiting', flavor: '変身', color: 'bg-zinc-700', description: '（1883年-1924年）オーストリア＝ハンガリー帝国領プラハ生まれのユダヤ系作家。20世紀文学界に「カフカ的」という言葉を残すほどの衝撃を与えた不条理文学の旗手。厳格で威圧的な実父との解消されない確執、そしてユダヤ人としての疎外感は、彼の文学的刻銘の全てに呪縛のように影響した。昼間は労働者傷害保険局の官僚として勤め上げ、夜間に孤独な執筆活動を行うという二重生活を続けた。代表作『変身』では、ある朝目覚めると巨大な毒虫になっていた男の悲喜劇を通じ、家族の変質と個人の疎外を描いた。生前はごく一部の作品しか世に出ず、死に際しては親友マックス・ブロートに全ての未発表原稿を焼却するよう命じたが、ブロートがこれを独断で背いたことにより『審判』『城』『失踪者』などの未完の傑作が世に出ることとなった。理由の判らぬ逮捕、近づけない城、迷宮のような官僚機構など、日常の中に突如現れる非現実的な悪夢を描きながらも、その文体は驚くほど明晰で即物的なのが特徴。サルトル、カミュ、村上春樹など後世の作家に計り知れない影響を与えた実存主義文学の先駆者である。1924年、結核により40歳で病没。', avatar: 'assets/kafka_warhol.png', isPreStyled: true },
  { id: 'borges', face: 0, pos: 7, name: 'ボルヘス', role: '図書館司書', homeLocationId: 'archive', flavor: '迷宮', color: 'bg-itako-sand', description: '（1899年-1986年）アルゼンチン、ブエノスアイレス生まれの稀代の博識家・詩人。ラテンアメリカ文学ブームの先駆けであり、20世紀後半の文学における「迷宮の主」として君臨した。家系の遺伝により若くして視力が衰え、晩年には完全に失明したが、その暗闇の中で記憶と膨大な読書体験を頼りに、宇宙的規模の想像力を羽ばたかせた。長編を一度も書かず、簡潔な短編や虚構のエッセイを通じて、夢、円環する時間、鏡、無限の図書室といった深遠なテーマを数学的・哲学的な緻密さで構築した。代表作『伝奇集』に収録された「バベルの図書館」や「円環の廃墟」は、知の深淵と現実の不確かさを突きつける不朽の名作。ブエノスアイレス国立図書館の館長を務め、「失明と膨大な本」という矛盾した運命を自らの詩的インスピレーションへと昇華させた。その博覧強記ぶりは、実在しない書の書評を書くというメタフィクションの手法を生み出し、ウンベルト・エーコ『薔薇の名前』やイタロ・カルヴィーノにも決定的な影響を与えた。時間は直線ではなく、常に繰り返される迷宮であると説いた彼の哲学は、ポストモダン文学の支柱となった。1986年、ジュネーヴにて永眠。', avatar: 'assets/borges_warhol.png', isPreStyled: true },
