...
export const INITIAL_CHARACTERS = [
  ...
  { id: 'curie', face: 2, pos: 3, name: 'マリー・キュリー', role: '科学者', homeLocationId: 'lighthouse', flavor: '放射線', color: 'bg-itako-sage', description: '（1867-1934）放射能の研究でノーベル賞を2回受賞。自らの命を削り未知の真理を照らした。', avatar: null },
