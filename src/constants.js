...
export const INITIAL_CHARACTERS = [
  // ── Face 0: 文豪列伝 ──────────────────────────────────────────────
  { id: 'soseki', face: 0, pos: 0, name: '夏目漱石', role: '大学教授', homeLocationId: 'school', flavor: '胃痛', color: 'bg-itako-clay', isMainChar: true, description: '（1867-1916）江戸牛込馬場下横町生まれ。近代日本文学を確立した国民的作家。ロンドン留学を経て『吾輩は猫である』でデビュー。「自己本位」を説き、個人の孤独とエゴイズムを鋭く描写した。', avatar: 'assets/soseki_warhol.webp', isPreStyled: true },
  ...
  // ── Face 1: 闇の系譜 ──────────────────────────────────────────────
  { id: 'dosto', face: 1, pos: 0, name: 'ドストエフスキー', role: '債務者・作家', homeLocationId: 'casino', flavor: '借金', color: 'bg-itako-sand', isMainChar: true, description: '（1821-1881）人間の深淵。擬似死を体験した男が描く、罪と罰、神と自由意志のポリフォニー。', avatar: 'assets/dosto_warhol.webp', isPreStyled: true },
  ...
  { id: 'ichikawa', face: 2, pos: 1, name: '市川房枝', role: '政治家', homeLocationId: 'office', flavor: '厳格', color: 'bg-itako-sage', isMainChar: true, description: '（1893-1981）婦人参政権運動の指導者。清廉潔白な政治姿勢で国民から深い信頼を得た。', avatar: 'assets/ichikawa_warhol.webp', isPreStyled: true },
  ...
  { id: 'marx', face: 3, pos: 6, name: 'マルクス', role: '革命家', homeLocationId: 'factory', flavor: '資本', color: 'bg-red-900/60', description: '（1818-1883）『資本論』。階級闘争により歴史が変革される必然を科学的に分析した。', avatar: null },
  ...
  // ── Face 5: 異界の存在 ──────────────────────────────────────────────
  { id: 'ishimure', face: 5, pos: 1, name: '石牟礼道子', role: '作家・詩人', homeLocationId: 'lake', flavor: '悶え加勢', color: 'bg-green-950/70', description: '（1927-2018）『苦海浄土』著者。水俣病患者の魂の訴えを巫女のごとく言葉に降ろし、文明病の影で失われた尊厳と土地の霊性を描き出した。', avatar: 'assets/ishimure_warhol.png', isPreStyled: true },
...
export const INITIAL_LOCATIONS = [
  ...
  { id: 'casino', name: '賽の河原', face: 3, pos: 1, tags: ['gambling', 'narrow'], description: '魂を賭けてサイコロを振る、終わりのない遊戯。', color: '#1a0505', pattern: 'radial-gradient(circle at center, #300 0%, #000 80%)' },
