...
export const INITIAL_CHARACTERS = [
  ...
  { id: 'rimbaud', face: 1, pos: 5, name: 'ランボー', role: '天才少年詩人', homeLocationId: 'slum', flavor: '放浪', color: 'bg-itako-sand', description: '感覚を錯乱させる「見者」の道。早熟な天才が20歳で文学を捨てた。', avatar: null },
  ...
  { id: 'woolf', face: 2, pos: 4, name: 'ヴァージニア・ウルフ', role: '作家', homeLocationId: 'lake', flavor: '意識', color: 'bg-blue-950/60', description: '意識の流れにより流動的な内面世界を描いたモダニズムの旗手。', avatar: null },
  { id: 'beauvoir', face: 2, pos: 5, name: 'ボーヴォワール', role: '哲学者', homeLocationId: 'cafe', flavor: '実存', color: 'bg-itako-clay', description: '「女になる」実存の自由と、社会的な構築への分析を説いた知性の象徴。', avatar: null },
  { id: 'nightingale', face: 2, pos: 6, name: 'ナイチンゲール', role: '管理者', homeLocationId: 'altar', flavor: '理性的慈悲', color: 'bg-itako-sage', description: '統計と理性を武器に具体的救済を成し遂げた近代看護の母。', avatar: null },
  { id: 'yosano', face: 2, pos: 7, name: '与謝野晶子', role: '歌人', homeLocationId: 'graveyard', flavor: '情熱', color: 'bg-red-900/50', description: '炎のような官能と反戦の不屈の心で、生命の躍動を歌い上げた情熱の星。', avatar: null },
  { id: 'higuchi', face: 2, pos: 8, name: '樋口一葉', role: '作家', homeLocationId: 'market', flavor: '悲哀', color: 'bg-itako-sand', description: '貧困という過酷な現実の中で、時代の移ろいと魂の貴さを描いた。', avatar: null },

  // ── Face 3: 西洋の魂 ──────────────────────────────────────────────
  { id: 'toynbee', face: 3, pos: 0, name: 'トインビー', role: '歴史家', homeLocationId: 'library', flavor: '挑戦', color: 'bg-zinc-700', description: '文明の興亡を「挑戦と応戦」の原理で解き明かした20世紀最大の歴史家。', avatar: null },
  ...
  { id: 'socrates', face: 3, pos: 3, name: 'ソクラテス', role: '哲学者', homeLocationId: 'oracle', flavor: '問答', color: 'bg-itako-sand', description: '対話によって確証を解体し、真理への探究を促し続ける西洋哲学の祖。', avatar: null },
  { id: 'descartes', face: 3, pos: 4, name: 'デカルト', role: '数学者・哲学者', homeLocationId: 'mirror', flavor: '方法', color: 'bg-zinc-700', description: '方法的懐疑。「我思う、ゆえに我あり」という確実な一点。', avatar: null },
  ...
  { id: 'hegel', face: 3, pos: 6, name: 'ヘーゲル', role: '弁証法の巨人', homeLocationId: 'tower', flavor: '精神進化', color: 'bg-zinc-700', description: '弁証法により、世界を絶対精神の進化のプロセスとして捉えた。', avatar: null },
  { id: 'marx', face: 3, pos: 7, name: 'マルクス', role: '社会学者', homeLocationId: 'factory', flavor: '構造批判', color: 'bg-red-900/60', description: '資本主義の本質を「搾取」と喝破し、歴史の構造的変革を追求。', avatar: null },
  { id: 'freud', face: 3, pos: 8, name: 'フロイト', role: '精神分析家', homeLocationId: 'waiting', flavor: '深層心理', color: 'bg-zinc-800', description: '日常を支配する「無意識」の存在を解き明かした精神分析の発見者。', avatar: null },
  { id: 'wittgenstein', face: 3, pos: 9, name: 'ウィトゲンシュタイン', role: '孤高の思想家', homeLocationId: 'void', flavor: '限界', color: 'bg-zinc-700', description: '言語の限界を世界の限界とし、語りえぬものへの沈黙を説いた。', avatar: null },
  ...
  { id: 'rilke', face: 4, pos: 7, name: 'リルケ', role: '詩人', homeLocationId: 'tower', flavor: '孤独', color: 'bg-itako-sand', description: '事物の観察と存在の孤独。失われゆくものを詩の中に救い出す。', avatar: null },
  ...
  // ── Face 5: 歴史と宗教 ──────────────────────────────────────────────
  { id: 'khaldun', face: 5, pos: 0, name: 'イブン・ハルドゥーン', role: '歴史家', homeLocationId: 'library', flavor: 'アサビーヤ', color: 'bg-amber-950/70', description: '歴史の周期律（アサビーヤの盛衰）を説く知の巨星。共同体の寿命を120年（3650日/3世代）と看破した。', avatar: null },
  { id: 'arendt', face: 5, pos: 1, name: 'ハンナ・アーレント', role: '政治哲学者', homeLocationId: 'office', flavor: '客観分析', color: 'bg-zinc-800', description: '「悪の凡庸さ」と権力の構造を冷徹に分析。感情を排した硬質な言語で真実を記述する。', avatar: null },
  { id: 'thucydides', face: 5, pos: 2, name: 'トゥキュディデス', role: '歴史家', homeLocationId: 'waiting', flavor: '権力動学', color: 'bg-zinc-700', description: '『戦史』の著者。恐怖、名誉、利益による権力構造の不可逆的な変化を観測する。', avatar: null },
  { id: 'dogen', face: 5, pos: 3, name: '道元', role: '禅師', homeLocationId: 'temple', flavor: '有時', color: 'bg-zinc-900', description: '「有時（時分、いまここ）」の哲学を説く。一瞬が永遠であり、万物が実相であることを教示す。', avatar: null },
