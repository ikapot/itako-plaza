...
export const INITIAL_CHARACTERS = [
  ...
  // ── Face 3: 西洋の魂 ──────────────────────────────────────────────
  { id: 'toynbee', face: 3, pos: 9, name: 'トインビー', role: '歴史家', homeLocationId: 'library', flavor: '文明', color: 'bg-zinc-700', description: '文明の興亡を「挑戦と応戦」の原理で解き明かし、人類の精神的連帯と愛を説いた20世紀最大の歴史家。', avatar: null },
